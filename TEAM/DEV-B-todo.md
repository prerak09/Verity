...
- [x] 1.3 Public company profile `[slug]/page.tsx` — RSC, all §17 modules read-only, LCP<2s (NFR 13.1)
- [x] 1.4 Public internship list + `[slug]` detail — external "Apply on company site" CTA (FR-25)
...
- [x] 4.2 Company Dashboard modules (verification banner, analytics cards, completeness %, internship counts) (PRD §15.2)
- [x] 4.3 Company Profile Editor forms — all §17 modules, autosave + "last saved" indicator (FR-11)
- [x] 4.4 Logo/media upload widget (Cloudinary signed preset from Dev A) (FR-16)
- [x] 4.5 Founders/co-founders/hiring-managers/recruiters repeatable editors (PRD §17)
...
- [x] 5.3 Admin Company + Internship management tables + moderation (PRD §14.3)
...
- [x] 5.11 E2E (Playwright): sign-up → search → view profile → bookmark → add to tracker → update status (TRD §20)
